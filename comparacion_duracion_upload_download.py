...
plt.tight_layout()
plt.savefig(os.path.join(metricas_dir, "duracion_upload.png"))
plt.close()
...
plt.xlabel("Protocolo")
plt.tight_layout()
plt.savefig(os.path.join(metricas_dir, "duracion_download.png"))
plt.close()

print(" Gráficos generados:")
print(f"- {os.path.join(metricas_dir, 'duracion_upload.png')}")
print(f"- {os.path.join(metricas_dir, 'duracion_download.png')}")
