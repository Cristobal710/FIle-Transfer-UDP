...
class ArchiveSender:
    ...
    def __init__(self, path):
        ...
        # Asegurar que el archivo empiece desde el principio
        self.archivo.seek(0)
    ...
    def next_pkg(self, seq_num=0):
        ...
        # Debug: verificar el primer byte del paquete
        primer_byte = pkg[0]
