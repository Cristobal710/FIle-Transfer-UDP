...
def start_network():
    ...
    h1.cmd(f'xterm -hold -e "cd {server_path}; python3 server.py start-server -H 10.0.0.1 -p 5000; bash" &')
    ...
    h2.cmd(f'xterm -hold -e "cd {client_path}; python3 client.py download -d ./downloadgbn.png -n test.png -r GBN -H 10.0.0.1 -p 5000 -v; bash" &')
